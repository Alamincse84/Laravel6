                                                ...
                                                <div  class="grid-arrival">
                                                    <figure>
                                                        <a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
                                                            ...
                                                            <div class="grid-img">
                                                                <img  src="{{asset('/front/')}}/images/si7.jpg" class="img-responsive"  alt="">
                                                            </div>
                                                        </a>
                                                    </figure>
                                                </div>
                                            ...
                                            <div class="grid-arr">
                                                <div  class="grid-arrival">
                                                    <figure>
                                                        <a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
                                                            <div class="grid-img">
                                                                <img  src="{{asset('/front/')}}/images/i12.jpg" class="img-responsive" alt="">
                                                            </div>
                                                            <div class="grid-img">
                                                                <img  src="{{asset('/front/')}}/images/i11.jpg" class="img-responsive"  alt="">
                                                            </div>
                                                        </a>
                                                    </figure>
                                                </div>
